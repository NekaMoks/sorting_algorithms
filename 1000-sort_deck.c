...
/**
 * insertion_sort_deck_kind - Sorting  deck cards to diamonds.
 * @deck: A pointer pointing to deck_node_t doubly-linked list.
 */
void insertion_sort_deck_kind(deck_node_t **deck)
{
...
/**
 * sort_deck - Sorting a deck of cards to king and diamond.
 * @deck: A pointer pointing to head of a deck_node_t doubly-linked list.
 */
void sort_deck(deck_node_t **deck)
{
